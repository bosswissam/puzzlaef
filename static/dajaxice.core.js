var Dajaxice = {
        ...
        main: {
            ...
            send_form: function(callback_function, argv, custom_settings){
                Dajaxice.call('puzzlaef.main.send_form', callback_function, argv, custom_settings);
            },
            ...
            find_locations: function(callback_function, argv, custom_settings){
                Dajaxice.call('puzzlaef.main.find_locations', callback_function, argv, custom_settings);
            }

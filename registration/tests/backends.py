...
from puzzlaef.registration import forms, signals
from puzzlaef.registration.admin import RegistrationAdmin
from puzzlaef.registration.backends import get_backend
from puzzlaef.registration.backends.default import DefaultBackend
from puzzlaef.registration.backends.simple import SimpleBackend
from puzzlaef.registration.models import RegistrationProfile
import datetime
...
class BackendRetrievalTests(TestCase):
    ...
    def test_get_backend(self):
        ...
        """
        self.failUnless(isinstance(get_backend('puzzlaef.registration.backends.default.DefaultBackend'),
                                   DefaultBackend))
    ...
    def test_backend_error_invalid(self):
        ...
        self.assertRaises(ImproperlyConfigured, get_backend,
                          'puzzlaef.registration.backends.doesnotexist.NonExistentBackend')
    ...
    def test_backend_attribute_error(self):
        ...
        """
        self.assertRaises(ImproperlyConfigured, get_backend,
                          'puzzlaef.registration.backends.default.NonexistentBackend')
...
class DefaultRegistrationBackendTests(TestCase):
    ...
    def test_form_class(self):
        ...
        ``puzzlaef.registration.forms.RegistrationForm``.

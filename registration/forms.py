...
from puzzlaef.recaptcha.client import captcha
...
class ReCaptchaRegistrationForm(RegistrationForm):#RegistrationFormUniqueEmail
    ...
    def __init__(self, data=None, remoteip=None, *args, **kwargs):
        ...
        super(ReCaptchaRegistrationForm, self).__init__(data=data, *args, **kwargs)
